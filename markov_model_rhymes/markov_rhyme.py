...
class MarkovRhymeGenerator:
    ...
    def _initialize_backward_model(self, corpus):
        ...
        return markovify.Text(reversed_corpus, state_size=3, well_formed=False)
    ...
    def generate_line_pair(self):
        ...
        second_line = self._get_rhyming_line(word_to_rhyme)
    ...
    def generate_rhyming_line(self, line, word_to_rhyme=None):
        ...
        rhyming_line = self._get_rhyming_line(word_to_rhyme)
        return rhyming_line
